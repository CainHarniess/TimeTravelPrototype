...
namespace Osiris.TimeTravelPuzzler.Interactables.FloorPads.Commands
{
    public class PressCommandFactory : CommandFactoryBase
    {
        ...
        {
            var inverse = new FloorPadDelegateCommand(candidateWeight, FloorPad.CanRelease, FloorPad.Release,
                                              FloorPad.RemoveWeight, "Floor pad press inverse");
            return new FloorPadDelegateCommand(candidateWeight, FloorPad.CanPress, FloorPad.Press,
                                       FloorPad.AddWeight, "Floor pad press", inverse);
        }
    }
}